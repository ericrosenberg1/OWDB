                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "details",
                            models.JSONField(
                                default=dict, help_text="Details of what was added/changed"
                            ),
                        ),
                        (
                            "ai_assisted",
                            models.BooleanField(
                                default=False, help_text="Whether Claude API was used"
                            ),
                        ),
                    ...
                    options={
                        ...
                        "indexes": [
                            models.Index(
                                ...
                                name="owdbapp_wre_action__e6fdcd_idx",
                            ),
                            models.Index(
                                fields=["entity_type", "entity_id"],
                                name="owdbapp_wre_entity__d2b355_idx",
                            ),
                            models.Index(
                                fields=["source", "created_at"],
                                name="owdbapp_wre_source_b45889_idx",
                            ),
                            models.Index(
                                fields=["ai_assisted", "created_at"],
                                name="owdbapp_wre_ai_assi_fc2db8_idx",
                            ),
                        ],
                    },
                ),
