    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="owdbapp_pro_name_0eae26_idx"),
                    models.Index(fields=["abbreviation"], name="owdbapp_pro_abbrevi_44a3d5_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="owdbapp_ven_name_320ec4_idx"),
                    models.Index(fields=["location"], name="owdbapp_ven_locatio_f7acf8_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "systems",
                    models.CharField(
                        blank=True, help_text="e.g., PS5, Xbox, PC", max_length=255, null=True
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="video_games", to="owdbapp.promotion"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "aliases",
                    models.TextField(
                        blank=True, help_text="Comma-separated list of aliases", null=True
                    ),
                ),
                ...
                (
                    "finishers",
                    models.TextField(
                        blank=True, help_text="Comma-separated list of finishing moves", null=True
                    ),
                ),
                ("about", models.TextField(blank=True, null=True)),
            ],
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="owdbapp_wre_name_4e049a_idx"),
                    models.Index(fields=["debut_year"], name="owdbapp_wre_debut_y_ec7075_idx"),
                    models.Index(fields=["nationality"], name="owdbapp_wre_nationa_8a6ce0_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "related_wrestlers",
                    models.ManyToManyField(
                        blank=True, related_name="specials", to="owdbapp.wrestler"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hosts",
                    models.TextField(
                        blank=True, help_text="Comma-separated list of hosts", null=True
                    ),
                ),
                ...
                (
                    "related_wrestlers",
                    models.ManyToManyField(
                        blank=True, related_name="podcasts", to="owdbapp.wrestler"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "match_text",
                    models.TextField(help_text="Description like 'The Rock vs Stone Cold'"),
                ),
                ...
                (
                    "match_order",
                    models.PositiveIntegerField(default=0, help_text="Order on the card"),
                ),
                ("about", models.TextField(blank=True, null=True)),
                (
                    "event",
                ...
                (
                    "wrestlers",
                    models.ManyToManyField(related_name="matches", to="owdbapp.wrestler"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "related_wrestlers",
                    models.ManyToManyField(blank=True, related_name="books", to="owdbapp.wrestler"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional name for this key",
                        max_length=100,
                        null=True,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["key"], name="owdbapp_api_key_c57e64_idx"),
                    models.Index(fields=["user"], name="owdbapp_api_user_id_ac6e0b_idx"),
                ],
            },
        ),
        migrations.AddIndex(
