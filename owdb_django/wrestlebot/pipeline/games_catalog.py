...
WRESTLING_GAME_SEEDS: dict[str, tuple[str, ...]] = {
    ...
    # =======================================================================
    "champion_wrestler": ("Champion Wrestler", "Champion Pro Wrestling"),
    "ring_king": ("Ring King",),
    "tag_team_wrestling": ("Tag Team Wrestling (video game)", "Tag Team Wrestling"),
    "appoooh": ("Appoooh",),
    "pro_wrestling_nes": (
    ...
    "the_main_event": ("The Main Event (arcade game)", "The Main Event (1988 video game)"),
    "mania_challenge": ("Mania Challenge",),
    "wrestlefest": ("WWF WrestleFest", "WrestleFest"),
    "wrestlemania_1989": ("WWF WrestleMania (1989 video game)", "WWF WrestleMania (video game)"),
    # =======================================================================
    # 16-bit era (Genesis / SNES / Game Boy) — the WWF heyday
    # =======================================================================
    "wwf_super_wrestlemania": ("WWF Super WrestleMania",),
    "wwf_royal_rumble": ("WWF Royal Rumble (video game)", "WWF Royal Rumble (1993 video game)"),
    "wwf_raw_1994": ("WWF Raw (1994 video game)", "WWF Raw (video game)"),
    ...
    "muscle_bomber": ("Muscle Bomber", "Muscle Bomber Duo"),
    # =======================================================================
    # PS1 / N64 — AKI Corporation revolution + WCW vs. WWF
    # =======================================================================
    "wcw_vs_the_world": ("WCW vs. the World",),
    "wcw_nwo_world_tour": ("WCW/nWo World Tour", "WCW vs. nWo: World Tour"),
    "wcw_vs_nwo_revenge": ("WCW/nWo Revenge", "WCW vs. nWo: Revenge"),
    "wcw_mayhem": ("WCW Mayhem",),
    "wcw_backstage_assault": ("WCW Backstage Assault",),
    "wcw_thunder": ("WCW Thunder (video game)", "WCW Thunder"),
    "wcw_nitro": ("WCW Nitro (video game)", "WCW Nitro"),
    "wwf_in_your_house": ("WWF In Your House (video game)", "WWF In Your House"),
    "wwf_warzone": ("WWF War Zone", "WWF Warzone"),
    "wwf_attitude": ("WWF Attitude",),
    "wwf_wrestlemania_2000": ("WWF WrestleMania 2000",),
    "wwf_no_mercy": ("WWF No Mercy",),
    "wwf_smackdown": ("WWF SmackDown!", "WWF SmackDown! (video game)"),
    "wwf_smackdown_2": ("WWF SmackDown! 2: Know Your Role",),
    "ecw_hardcore_revolution": ("ECW Hardcore Revolution",),
    "ecw_anarchy_rulz": ("ECW Anarchy Rulz", "ECW Anarchy Rulz!"),
    ...
    "wwe_smackdown_here_comes_the_pain": ("WWE SmackDown! Here Comes the Pain",),
    "wwe_smackdown_vs_raw": ("WWE SmackDown! vs. Raw", "WWE SmackDown vs. Raw"),
    "wwe_smackdown_vs_raw_2006": ("WWE SmackDown! vs. Raw 2006", "WWE SmackDown vs. Raw 2006"),
    ...
    "wwf_raw_2002": ("WWF Raw (2002 video game)", "WWE Raw (video game)"),
    "wwe_raw_2": ("WWE Raw 2",),
    ...
    "tna_impact": ("TNA Impact!", "TNA Impact! (video game)"),
    ...
    "wwe_2k24": ("WWE 2K24",),
    "wwe_2k25": ("WWE 2K25",),
    "wwe_2k_mobile": ("WWE Mayhem", "WWE SuperCard", "WWE Champions"),
    "aew_fight_forever": ("AEW: Fight Forever", "AEW Fight Forever"),
    "tna_wrestling": ("TNA Wrestling (video game)",),
    "lucha_libre_aaa": ("Lucha Libre AAA: Héroes del Ring", "Lucha Libre AAA"),
    # =======================================================================
    ...
    # =======================================================================
    "wwe_2k_series": ("WWE 2K", "WWE 2K (series)"),
    "wwf_wcw_smackdown_series": ("List of WWE video games", "WWF/WWE video games"),
    "fire_pro_wrestling_series": (
        "Fire Pro Wrestling",
        "Fire Pro Wrestling (series)",
        "Fire Pro Wrestling World",
    ),
    "wrestle_kingdom_series": ("Wrestle Kingdom (video game series)", "Wrestle Kingdom"),
    "njpw_world_pro_wrestling": (
        "New Japan Pro-Wrestling World",
        "World Pro Wrestling (TV series)",
    ),
    "kings_of_wrestling_series": (
        "MDickie",  # the WrestleMaster / WR series creator
        "WrestleMaster",
    ),
    "wrestling_revolution_3d": ("Wrestling Revolution 3D", "Wrestling Revolution"),
    # =======================================================================
    # Indie / experimental / mobile that DO have notability
    # =======================================================================
    "kayfabe_mgmt": ("Kayfabe (video game)", "Wrestling Empire"),
    "wwe_wrestlefest_2012": ("WWE WrestleFest",),
    "wwe_super_card": ("WWE SuperCard",),
    "wwe_champions": ("WWE Champions (video game)", "WWE Champions"),
    ...
    "list_professional_wrestling_video_games": ("List of professional wrestling video games",),
}
