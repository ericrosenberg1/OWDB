    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.JSONField(default=dict, help_text="Details of what was added/changed"),
                ),
                (
                    "ai_assisted",
                    models.BooleanField(default=False, help_text="Whether Claude API was used"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["action_type", "created_at"], name="owdbapp_wre_action__a1b2c3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="wrestlebotactivity",
            index=models.Index(
                fields=["entity_type", "entity_id"], name="owdbapp_wre_entity__d4e5f6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="wrestlebotactivity",
            index=models.Index(
                fields=["source", "created_at"], name="owdbapp_wre_source__g7h8i9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="wrestlebotactivity",
            index=models.Index(
                fields=["ai_assisted", "created_at"], name="owdbapp_wre_ai_assi_j0k1l2_idx"
            ),
        ),
    ]
