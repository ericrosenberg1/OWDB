...
from ..linking import (
    build_about_with_links,
    build_linked_from_summary,
    build_linked_from_sections,
)
...
@register.filter
def linked_from_sections(obj):
    """Return structured linked-from sections for rich display."""
    return build_linked_from_sections(obj)
