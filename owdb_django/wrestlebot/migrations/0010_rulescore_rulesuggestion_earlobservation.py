    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "severity",
                    models.CharField(db_index=True, help_text="warning | error", max_length=20),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["rule_id", "status"], name="wrestlebot__rule_id_64b5d4_idx"
                    ),
                    models.Index(
                        fields=["entity_type", "entity_id", "rule_id"],
                        name="wrestlebot__entity__082b0b_idx",
                    ),
                ],
